...
<html lang="en">
	...
	<body>
		...
		<script type="text/javascript">
			(function (d, w, c) {
				(w[c] = w[c] || []).push(function() {
					try {
						w.yaCounter42018909 = new Ya.Metrika({
							id:42018909,
							clickmap:true,
							trackLinks:true,
		...
		<noscript><div><img src="https://mc.yandex.ru/watch/42018909" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
		<!-- /Yandex.Metrika counter -->
		<header>
			<nav class="desktop">
		...
		<section id="block2">
			<div class="content">
				<div class="services">
					...
					<div class="item_wrap">
						<div class="item">
							<img src="img/html_css_js_jquery.png" /><br />
							<div class="text">Верстка сайтов различной сложности</div>
						</div>
					</div>
					<div class="item_wrap">
						<div class="item">
							<img src="img/document_pencil.png" /><br />
							<div class="text">Исправление готовых макетов, внесение правок</div>
						</div>
					</div>
					<div class="item_wrap">
						<div class="item">
							<img src="img/adapt.png" /><br />
							<div class="text">Адаптирование верстки под мобильные устройства</div>
						</div>
					</div>
					<div class="item_wrap">
						<div class="item">
							<img src="img/web_browsers.png" /><br />
							<div class="text">Кроссбраузерная, валидная верстка</div>
						</div>
					</div>
					<div class="item_wrap">
						<div class="item">
							<img src="img/psd2html.png" />
							<div class="text">Верстка psd-макетов, попиксельная верстка</div>
						</div>
					</div>
					<div class="item_wrap">
						<div class="item">
							<img src="img/animate.png" />
							<div class="text">Создание баннеров с помощью Adobe Edge Animate</div>
						</div>
					</div>
				</div>
			</div>
		...
		<section id="block3">
			<div class="content">
				...
				<div class="item">
					...
					<div class="bottom">
						<div class="wrapA">
							<a href="https://icedigital.ru/" target="_blank">https://icedigital.ru/</a>
						</div>
					</div>
				</div><!--item-->
				<div class="item">
			...
			<div class="content">
				...
				<div class="wrap">
					<ul>
						...
						<li>Демократичные цены: стоимость одного часа работы составляет от 5 до 10 у.е.</li>
					</ul>
				</div>
			</div>
		</section>
